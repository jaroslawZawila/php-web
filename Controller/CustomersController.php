 ...
 */
	public function view($id = null) {
		if (!$this->Customer->exists($id)) {
			throw new NotFoundException(__('Cannot find customer.'));
		}
...
//		if (!$this->Customer->exists($id)) {
//			throw new NotFoundException(__('Customer cannot be found.'));
//		}
//		if ($this->request->is(array('post', 'put'))) {
//			if ($this->Customer->save($this->request->data)) {
//				$this->Session->setFlash(__('The customer details has been saved.'));
//				return $this->redirect(array('action' => 'index'));
//			} else {
//				$this->Session->setFlash(__('The customer details could not be saved. Please, try again.'));
//			}
//		} else {
//			$options = array('conditions' => array('Customer.' . $this->Customer->primaryKey => $id));
