<div class="row-fluid">
    ...
    <div class="span7">
        <div class="panel panel-info">
            <div class="panel panel-heading">
                <h2 class="panel-title" id="search-title"><?php echo $resultstitle ?></h2>
            </div>
            <div class="panel-body">
                <div class="properties index">
                    <table cellpadding="0" cellspacing="0">
                        <?php if(count($properties)==0){ echo '<div class="alert alert-danger" id="search-msg">Sorry we cannot find
